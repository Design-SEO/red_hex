    ...
    <body class="wp-singular page-template-default page page-id-1143 wp-theme-target_landing non-front-page">
        ...
        <div id="content" class="page_content_wrapper" role="main">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div id="create-account-form" class="wp-block-group has-white-background-color has-background">
                            <div class="wp-block-group__inner-container is-layout-constrained wp-block-group-is-layout-constrained">
                                <h2 class="wp-block-heading has-text-align-center has-medium-font-size">
                                    <strong>
                                        <?php echo getLang('account_h1') ?>
                                    </strong>
                                </h2>
                                ...
                                <div class="wp-block-group bottom">
                                    <div class="wp-block-group__inner-container is-layout-constrained wp-block-group-is-layout-constrained">
                        ...
                        <div id="create-account-always" class="wp-block-group">
                            <div class="wp-block-group__inner-container is-layout-constrained wp-block-group-is-layout-constrained">
                                <h2 class="wp-block-heading has-text-align-center" style="font-style:normal;font-weight:600">
                                    <?php echo getLang('account_card_title') ?>
                                </h2>
                                <div class="wp-block-columns is-layout-flex wp-container-core-columns-is-layout-9d6595d7 wp-block-columns-is-layout-flex">
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                        <div class="wp-block-image">
                                            <figure class="aligncenter size-full is-resized">
                                                <img decoding="async" width="72" height="72" src="/assets/images/create-account-icon1.png.webp" alt="" class="wp-image-3468" style="width:36px">
                                            </figure>
                                        </div>
                                        <p class="has-text-align-center" style="font-style:normal;font-weight:500">
                                            <?php echo getLang('account_card_1') ?>
                                        </p>
                                    </div>
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                        <div class="wp-block-image">
                                            <figure class="aligncenter size-full is-resized">
                                                <img decoding="async" width="72" height="72" src="/assets/images/create-account-icon2.png.webp" alt="" class="wp-image-3490" style="width:36px">
                                            </figure>
                                        </div>
                                        <p class="has-text-align-center" style="font-style:normal;font-weight:500">
                                            <?php echo getLang('account_card_2') ?>
                                        </p>
                                    </div>
                                    <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
                                        <div class="wp-block-image">
                                            <figure class="aligncenter size-full is-resized">
                                                <img decoding="async" width="72" height="72" src="/assets/images/create-account-icon3.png.webp" alt="" class="wp-image-3512" style="width:36px">
                                            </figure>
                                        </div>
                                        <p class="has-text-align-center" style="font-style:normal;font-weight:500">
                                            <?php echo getLang('account_card_3') ?>
                                        </p>
                                    </div>
                                </div>
                            </div>
