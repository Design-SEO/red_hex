...
function getLang(string $key): string|array
{
    ...
    if (isset($t[$default][$key])) return $t[$default][$key];
    return '';
}
...
{
    $baseUrl = 'https://myalphaguide.com';
    $translations = loadTranslations();
...
{
    $lang = getLangFromFolder();
    $site_url = 'https://myalphaguide.com';
    $site_name = 'CapitureX';
    $author_name = 'CapitureX Team';
    $logo_path = '/assets/images/Logo.png';
    $dashboard_image = '/assets/images/Logo.png'; // Единое изображение для всех страниц
    ...
    $jsonLd1 = [
        ...
        'review' => [
            ...
            'reviewBody' => getLang('jsonld_organization_review_body') ?: 'CapitureX provides an investing platform with intelligent tools, flexible portfolios, and clear reporting to help clients in London manage and grow their money with confidence.',
            'reviewRating' => [
                '@type' => 'Rating',
            ...
            'author' => [
                '@type' => 'Person',
                'name' => getLang('jsonld_organization_review_author') ?: 'CapitureX User',
            ],
            'publisher' => [
                '@type' => 'Organization',
                'name' => getLang('jsonld_organization_name'),
    ...
    $jsonLd4 = [
        ...
        'keywords' => getLang($keywords_key) ?: 'about CapitureX, investing platform, AI investments London',
    ];
    ...
    if ($page === 'index') {
        ...
        $jsonLd7 = [
            ...
            'name' => getLang('jsonld_financialservice_name') ?: 'CapitureX Investment Services',
            'description' => getLang('jsonld_financialservice_description') ?: 'CapitureX offers secure cryptocurrency investing services starting from £182, with intelligent tools, flexible portfolios, and FCA-compliant support for UK investors in London and beyond.',
